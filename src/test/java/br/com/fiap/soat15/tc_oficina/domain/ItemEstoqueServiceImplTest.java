...
import br.com.fiap.soat15.tc_oficina.domain.impl.ItemEstoqueServiceImpl;
...
class ItemEstoqueServiceImplTest {
    ...
    void deveCriarItem() throws Exception {
        ...
        ItemEstoqueDTO itemSalvo = itemEstoqueService.criarItem(itemEstoque.convertToDTO());
    ...
    void criarITem_ComValidacaoInvalida_DeveRetornarBadRequest() throws Exception {
        ...
        assertThatThrownBy(() -> itemEstoqueService.criarItem(itemEstoque.convertToDTO()))
    ...
    void deveAtualizarItem() throws Exception {
        ...
        when(itemEstoqueService.atualizarItem(id, itemModificado.convertToDTO())).thenReturn(itemModificado);

        ItemEstoque itemSalvo = itemEstoqueService.atualizarItem(id, itemModificado.convertToDTO());
    ...
    void deveAtualizarItem_ComIdInexistente_DeveRetornarBadRequest() throws Exception {
        ...
        assertThatThrownBy(() -> itemEstoqueService.atualizarItem(id, itemEstoque.convertToDTO()))
                .isInstanceOf(NoSuchElementException.class)
                .hasMessageContaining("Item não encontrado");
